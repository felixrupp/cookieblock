 ...
 */
        var CookieBlock = function() {
            ...
            return _createClass(CookieBlock, [ {
                key: "init",
                value: function() {
                    var _this = this, cookieValue = this.getCookieBlockCookie();
                    console.log("Initial Cookie Values:"), console.log(cookieValue), null === cookieValue ? (console.log("Manage DNT before Cookie:"), 
                    console.log(this.manageDoNotTrack()), console.log("Default Plugin Options:"), console.log(this.pluginOptions), 
                    this.setCookieBlockCookie(this.pluginOptions)) : (this.pluginOptions = cookieValue, 
                    console.log("Manage DNT after Cookie:"), console.log(this.manageDoNotTrack()), this.setCookieBlockCookie(this.pluginOptions)), 
                    console.log("Cookie/Plugin Values:"), console.log(this.getCookieBlockCookie()), 
                    this.pluginOptions.forEach(function(options, moduleId) {
                        _this.manageCookie(moduleId);
                    });
                }
            }, {
                ...
                value: function(moduleId) {
                    var moduleOptions = this.pluginOptions.get(moduleId), moduleObject = this.pluginObjects.get(moduleId);
                    moduleOptions.active = !0, moduleObject.object.block(), this.pluginOptions.set(moduleId, moduleObject), 
                    this.setCookieBlockCookie(this.pluginOptions);
                }
            }, {
                ...
                value: function() {
                    if (this.appOptions.get("respectDoNotTrack")) {
                        ...
                        if (hasDNT || ie9DNT || ie10DNT) return console.log("DNT is enabled"), this.pluginOptions.forEach(function(options, moduleId) {
                            options.active = !0;
                        }), !0;
                    }
                    return console.log("DNT is false"), !1;
                }
            }, {
                key: "setAppOption",
