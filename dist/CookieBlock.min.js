 ...
 */
        ...
        var _createClass = function() {
            ...
            function AbstractBlockModule() {
                ...
                _classCallCheck(this, AbstractBlockModule), this.classOptions = options;
            }
 ...
 */
            ...
            return _createClass(CookieBlock, [ {
                ...
                value: function() {
                    ...
                    null === cookieValue) {
                        ...
                        this.pluginOptions = cookieValue, console.log("Plugin Values before DNT Manage:"), 
                        console.log(this.pluginOptions), console.log("Manage DNT after Cookie:");
                        var _dntActive = this.manageDoNotTrack();
                        console.log(_dntActive), console.log("Plugin Values after DNT Manage:"), console.log(this.pluginOptions), 
                        this.setCookieBlockCookie(this.pluginOptions);
                    }
                ...
                value: function(moduleId) {
                    ...
                    moduleOptions.active = !1, moduleObject.object.unblock(), this.pluginOptions.set(moduleId, moduleOptions), 
                    this.setCookieBlockCookie(this.pluginOptions);
                }
            }, {
                key: "enableModule",
                value: function(moduleId) {
                    var moduleOptions = this.pluginOptions.get(moduleId), moduleObject = this.pluginObjects.get(moduleId);
                    moduleOptions.active = !0, moduleObject.object.block(), this.pluginOptions.set(moduleId, moduleOptions), 
                    this.setCookieBlockCookie(this.pluginOptions);
                }
            }, {
                key: "setModuleOptions",
                value: function(moduleId, options) {
                    ...
                    moduleOptions.options = options, this.pluginOptions.set(moduleId, moduleOptions), 
                    this.setCookieBlockCookie(this.pluginOptions);
                }
            }, {
                key: "manageCookie",
                ...
                value: function() {
                    if (this.appOptions.get("respectDoNotTrack")) {
                        ...
                        if (void 0 !== window.navigator.doNotTrack && null !== window.navigator.doNotTrack && (hasDNT = window.navigator.doNotTrack, 
                        console.log(hasDNT)), "external" in window) {
                        ...
                        if (hasDNT || ie9DNT || ie10DNT) return this.pluginOptions.forEach(function(options, moduleId) {
                            options.active = !0;
        ...
        var _createClass = function() {
            ...
            function GoogleAnalytics() {
                ...
                return console.log("GA Module:"), _this;
            }
            return _inherits(GoogleAnalytics, _AbstractBlockModule), _createClass(GoogleAnalytics, [ {
                ...
                value: function() {
                    ...
                    this.classOptions instanceof Array && this.classOptions.length > 0 ? (console.log("Blocking Google Analytics"), 
                    window["ga-disable-UA-" + this.classOptions[0]] = !0) : console.log("Not Blocking Google Analytics, no propertyId.");
                }
            }, {
                key: "unblock",
                value: function() {
                    this.classOptions instanceof Array ? (console.log("Unblocking Google Analytics"), 
                    window["ga-disable-UA-" + this.classOptions[0]] = !1) : console.log("Not Unblocking Google Analytics, no propertyId.");
                }
            } ]), GoogleAnalytics;
        ...
        var _AbstractBlockModule2 = __webpack_require__(46), _AbstractBlockModule3 = _interopRequireDefault(_AbstractBlockModule2), Piwik = function(_AbstractBlockModule) {
            function Piwik() {
                return _classCallCheck(this, Piwik), _possibleConstructorReturn(this, (Piwik.__proto__ || Object.getPrototypeOf(Piwik)).apply(this, arguments));
            }
            return _inherits(Piwik, _AbstractBlockModule), Piwik;
        }(_AbstractBlockModule3["default"]);
